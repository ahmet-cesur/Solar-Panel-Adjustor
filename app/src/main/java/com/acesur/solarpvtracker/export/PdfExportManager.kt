...
class PdfExportManager(private val context: Context) {
    ...
    fun generateMonthlyReport(
        ...
        // Draw header
        yPosition = drawHeader(canvas, yPosition, context.getString(R.string.pdf_report_monthly_title), latitude, longitude)
        yPosition += 20f
        ...
        val headers = listOf(
            ...
            context.getString(R.string.pdf_col_month_name),
            context.getString(R.string.pdf_col_angle),
            context.getString(R.string.pdf_col_notes)
        )
    ...
    fun generateDailyReport(
        ...
        val headers = MutableList(colsPerRow * 2) { i ->
            if (i % 2 == 0) context.getString(R.string.pdf_col_date) else context.getString(R.string.optimal_angle)
        }
        ...
        for (pageNum in 0 until totalPages) {
            ...
            if (pageNum == 0) {
                yPosition = drawHeader(canvas, yPosition, context.getString(R.string.pdf_report_daily_title), latitude, longitude)
                yPosition += 10f
            } else {
                yPosition += 20f
                canvas.drawText(context.getString(R.string.pdf_report_daily_page, pageNum + 1), MARGIN, yPosition, subtitlePaint)
                yPosition += 30f
            }
    ...
    private fun drawHeader(
        ...
        canvas.drawText(context.getString(R.string.pdf_location_label, latitude, longitude), MARGIN, y + 15f, subtitlePaint.apply { textSize = 11f })
        y += 18f
        canvas.drawText(context.getString(R.string.pdf_generated_label, dateStr), MARGIN, y + 15f, subtitlePaint)
        y += 25f
    ...
    private fun drawFooter(canvas: Canvas) {
        ...
        canvas.drawText(
            context.getString(R.string.pdf_report_footer),
            MARGIN,
            footerY,
